					...
					<div class="span8">
						<div class="bs-docs-example">
							<div id="accordion2" class="accordion">
								...
								<div class="accordion-group">
									<div class="accordion-heading">
										<a href="#collapseFour" data-parent="#accordion2"
											data-toggle="collapse" class="accordion-toggle">
											<h4>
												<i class="icon-user"></i> 个人信息管理
											</h4>
										</a>
									</div>
									<div class="accordion-body collapse" id="collapseFour"
										...
										<div class="accordion-inner">
											<form>
												<label for="id1"> 注册邮箱 <a>修改 </a> <a>确认 </a> <a>取消</a></label>
												<input type="text" id="id1" name="" class="span6"
													value="hope6537@qq.com" readonly />
												<!--  -->
												<label for="id1"> 注册邮箱 </label> <input class="span6"
								...
								<div class="accordion-group">
									<div class="accordion-heading">
										<a href="#collapseThree" data-parent="#accordion2"
											data-toggle="collapse" class="accordion-toggle">
											<h4>
												<i class="icon-book
												"></i> 博客管理
