...
<link rel="stylesheet"
	href="assets/js/woothemes-FlexSlider-06b12f8/flexslider.css"
	type="text/css" media="screen" />
<link rel="stylesheet"
	href="assets/js/prettyPhoto_3.1.5/prettyPhoto.css" type="text/css"
	media="screen" />
...
<!-- Fav and touch icons -->
<link rel="assets/apple-touch-icon-precomposed" sizes="114x114"
	href="assets/apple-touch-icon-114x114-precomposed.png" />
<link rel="assets/apple-touch-icon-precomposed" sizes="72x72"
